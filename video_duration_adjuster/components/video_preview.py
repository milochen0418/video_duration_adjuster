    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                rx.el.div(
                    rx.el.h3(
                        "Original Video", class_name="text-lg font-bold text-white mb-4"
                    ),
                    rx.el.video(
                    ...
                    class_name="mb-8 overflow-hidden",
                ),
                rx.cond(
                ...
                class_name="flex-1 p-8 rounded-[2.5rem] bg-gray-900/80 backdrop-blur-xl border border-white/10 shadow-3xl",
            ),
            time_controls(),
            class_name="flex flex-col lg:flex-row gap-8 w-full max-w-7xl",
        ),
